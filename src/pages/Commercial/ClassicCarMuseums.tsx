...
import { Mouse as Museum, Shield, Building2, Check, FileText, Phone, MapPin, AlertTriangle, Users, DollarSign, Lock } from 'lucide-react';

export default function ClassicCarMuseums() {
  return (
    <div className="bg-white">
      ...
      <div className="relative h-[600px]">
        <div 
          ...
          style={{ 
            backgroundImage: 'url(https://images.unsplash.com/photo-1617469767053-d3b523a0b982?auto=format&fit=crop&q=80&w=2070)',
          ...
          <div className="max-w-2xl">
            <div className="space-y-6">
              ...
              <p className="text-xl text-gray-300">
                When most people think about museums, they think of the wonderful collections they contain. We also see the many facets of hidden risk that come with maintaining and displaying a valuable collection.
              </p>
      ...
      <div className="py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-bold text-center mb-16">Important Collections Deserve The Best Protection</h2>
            
            <div className="grid md:grid-cols-3 gap-8">
              {[
                {
                  icon: Shield,
                  title: "Total Museum Protection",
                  description: "Comprehensive coverage for your collection, exhibits, and organization from all risks.",
                  gradient: "bg-gradient-to-br from-[#91202B] to-[#c13543]"
                },
                {
                  icon: Building2,
                  title: "Agreed Value Coverage",
                  description: "Physical damage protection at pre-agreed values for your entire collection.",
                  gradient: "bg-gradient-to-br from-[#7a1b24] to-[#91202B]"
                },
                {
                  icon: Lock,
                  title: "All Risk Coverage",
                  description: "Protection for your building, contents, and historic features at replacement cost.",
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <div className="bg-white p-8 rounded-xl shadow-lg">
                <h3 className="text-2xl font-bold mb-6">Collection Coverage</h3>
                <div className="space-y-4">
                  {[
                    "Agreed Value coverage for all exhibited items",
                    "Protection for stored and displayed collections",
                    "Coverage for artwork and memorabilia",
                    "Transit and temporary location coverage",
                    "Protection during special events"
                  ].map((item, index) => (
              ...
              <div className="bg-white p-8 rounded-xl shadow-lg">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    "Historic features and architectural elements",
                    "Equipment and display cases",
                    "Computer systems and technology",
                    "Gift shop inventory protection"
                  ].map((item, index) => (
                    <div key={index} className="flex items-start">
                      <Check className="w-5 h-5 text-[#91202B] mr-3 mt-1" />
                      <span className="text-gray-700">{item}</span>
      ...
      <div className="py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-bold text-center mb-16">Comprehensive Liability Protection</h2>
              ...
              {[
                {
                  ...
                  description: "Protection for visitor injuries, special events, and general operations including gift shops and food service.",
                  features: [
                ...
                },
                {
                  ...
                  description: "Coverage for directors, officers, and employment practices to protect against various claims.",
                  features: [
                ...
                },
                {
                  ...
                  description: "Extra protection for business income, crime, and auto liability needs.",
                  features: [
                ...
                <div key={index} className="bg-gray-50 rounded-xl p-8">
                  <coverage.icon className="w-12 h-12 text-[#91202B] mb-6" />
                  <h3 className="text-xl font-bold mb-4">{coverage.title}</h3>
      ...
      <div className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl font-bold mb-6">Protect Your Museum</h2>
            <p className="text-gray-600 mb-12">
              Contact us to learn how we can provide comprehensive protection for your museum and collection.
            </p>
